...
module.exports = {
  ...
  emergencyRepository: new (require('./mongo/EmergencyRepository'))(),
  nursingRepository: new (require('./mongo/NursingRepository'))(),
  pharmacyRepository: new (require('./mongo/PharmacyRepository'))(),
  pathologyRepository: new (require('./mongo/PathologyRepository'))(),
  radiologyRepository: new (require('./mongo/RadiologyRepository'))(),
  hospitalBillingRepository: new (require('./mongo/HospitalBillingRepository'))(),
  icuRepository: new (require('./mongo/ICURepository'))(),
  otRepository: new (require('./mongo/OTRepository'))(),
  anesthesiaRepository: new (require('./mongo/AnesthesiaRepository'))(),
  bloodBankRepo: new (require('./mongo/BloodBankRepository'))(),
  specialtyClinicalRepository: new (require('./mongo/SpecialtyClinicalRepository'))(),
  physiotherapyRepo: new (require('./mongo/PhysiotherapyRepository'))(),
  dentalRepo: new (require('./mongo/DentalRepository'))(),
  dieteticsRepo: new (require('./mongo/DieteticsRepository'))(),
  mortuaryRepo: new (require('./mongo/MortuaryRepository'))(),
  biomedicalRepo: new (require('./mongo/BiomedicalRepository'))(),
  telemedicineRepo: new (require('./mongo/TelemedicineRepository'))(),
  auditLogRepo: new (require('./mongo/AuditLogRepository'))()
};
